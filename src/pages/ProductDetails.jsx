...
const ProductDetails = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      text: "Very good and awesome product",
      avatar:
        "https://ui-avatars.com/api/?name=Atharva+Kumar&background=F31260&color=fff",
    },
  ];
        ...
        <div className="product_details_right ms-5">
          ...
          <div className="d-flex justify-content-between">
            <div>
              ...
              <p style={{ color: "rgb(0, 255, 0)" }}>You save: ₹5,34 (33%)</p>
          ...
          {activeTab === "overview" && (
            <div>
              ...
              <p>
                ...
                {product.type} Headphones provides with fabulous sound quality
              </p>
              ...
              <p className="text-lg">
                Buy the {product.title} {product.type} which offers you with
                fabulous music experience by providing you with awesome sound
                quality that you can never move on from.
                <br /> Enjoy perfect flexibility and mobility with amazing
                musical quality with these Earbuds giving you a truly awesome
                audio experience. It blends with exceptional sound <br />
